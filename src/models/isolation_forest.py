...
def isolation_forest(channel_data, channel, report_path):
    """
...
def main():
    ...
    """
    report_path = f"results/isolation_forest.txt"
    ...
    for channel in standard_fitted_data:
        isolation_forest(standard_fitted_data[channel], channel, report_path)
